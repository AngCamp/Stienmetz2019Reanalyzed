...
filename = append(pwd,'\','probefile.txt');
FID = fopen(filename);
data = textscan(FID,'%s');
fclose(FID);
probename = string(data{:});

lfp_path = append('C:\Users\angus\Desktop\SteinmetzLab\LFP\',probename,'.imec.lf.bin');
